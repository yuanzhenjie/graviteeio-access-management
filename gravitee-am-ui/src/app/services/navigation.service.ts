...
import {ActivatedRouteSnapshot, ActivationEnd, Data, NavigationEnd, Router} from "@angular/router";
...
export class NavigationService implements OnDestroy {
  ...
  getBreadcrumbItems(route: ActivatedRouteSnapshot): any[] {
    ...
    if (route != null) {
      ...
      let breadcrumbData = routeConfig && routeConfig.data && routeConfig.data.breadcrumb && routeConfig.data.breadcrumb;
